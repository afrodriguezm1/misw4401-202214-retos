...
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "uniandesUser";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "uniandesCode";
...
// Función para convertir la entrada analoga de la fotoresistencia a un valor de lumens (lm)
// Recibe un entero y retorna entero
...
void loop()
{
  ...
  // Light sensor
  int l = sensorRawToPhys(analogRead(sensor_pin));
